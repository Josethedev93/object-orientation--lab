...
const gandalf = new Wizard('Gandalf', 10000, 'fireworks')
...
const phoneOne = new Phone('samsung', 's22 ultra', 120, 'green', 1000)

const phoneTwo = new Phone('apple', 'iphone', 120, 'black', 1020)

const phoneThree = new Phone('samsung', 'fold', 120, 'black', 1200)
...
const myFirstvehicle = new Vehicle(5, 'black', 43000)
...
const myFirstMotorcycle = new Motorcycle(1, 'green', 5000, 'Harley', true )
...
const myFirstBoat = new Boat(15, 'green', 10000, 'ninamaria', 'yacht', false)
